...
const INJECTED_STYLES = `
  ...
  .text-3d-matte {
      color: #e0f2fe;
      text-shadow: 0 0 40px rgba(34,211,238,0.5), 0 2px 4px rgba(0,0,0,0.3);
  }

  .text-silver-matte {
      background: linear-gradient(90deg, #22d3ee 0%, #3b82f6 40%, #a855f7 70%, #22d3ee 100%);
      ...
      filter: drop-shadow(0px 0px 20px rgba(34,211,238,0.4));
  }
  ...
  @keyframes pulse-glow {
    0%, 100% { box-shadow: 0 0 40px rgba(14,165,233,0.35), 0 0 80px rgba(14,165,233,0.12), inset 0 1px 1px rgba(255,255,255,0.18); }
    50% { box-shadow: 0 0 60px rgba(14,165,233,0.55), 0 0 120px rgba(14,165,233,0.2), inset 0 1px 1px rgba(255,255,255,0.22); }
  }
`;
...
export function CinematicHero({
  brandName = "DarkSanta",
  tagline1 = "Own the server,",
  tagline2 = "rule the world.",
  cardHeading = "Minecraft hosting, redefined.",
  cardDescription = (
    <>
      <span className="text-white font-semibold">DarkSanta</span> delivers
      premium Minecraft server hosting with instant setup, ultra-low latency,
      and 99.9% uptime — built for serious players.
    </>
  ),
  metricValue = 999,
  metricLabel = "ms Latency",
  ctaHeading = "Start your server.",
  ctaDescription = "Join thousands of players already running on DarkSanta infrastructure. Launch in under 60 seconds.",
  className,
  ...props
}: CinematicHeroProps) {
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* biome-ignore lint/security/noDangerouslySetInnerHtml: GSAP requires injected styles */}
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <a
          ...
          className="group relative flex items-center gap-3 px-10 py-5 rounded-2xl font-bold text-lg text-white overflow-hidden"
          style={{
            background:
              "linear-gradient(135deg, rgba(14,165,233,0.18) 0%, rgba(139,92,246,0.18) 100%)",
            backdropFilter: "blur(20px)",
            WebkitBackdropFilter: "blur(20px)",
            border: "1px solid rgba(14,165,233,0.45)",
            boxShadow:
              "0 0 40px rgba(14,165,233,0.35), 0 0 80px rgba(14,165,233,0.12), inset 0 1px 1px rgba(255,255,255,0.18)",
          ...
          onMouseEnter={(e) => {
            ...
            el.style.boxShadow =
              "0 0 60px rgba(14,165,233,0.55), 0 0 120px rgba(14,165,233,0.22), inset 0 1px 1px rgba(255,255,255,0.25)";
          }}
          onMouseLeave={(e) => {
            const el = e.currentTarget as HTMLAnchorElement;
            el.style.transform = "";
        ...
        >
          ...
          />
          <span
            className="relative z-10 text-silver-matte"
            style={{ fontFamily: "'Orbitron', sans-serif" }}
          >
            Get Started
          </span>
